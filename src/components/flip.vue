...
<template>
  <ButtonGroup size="small">
    <Button :disabled="notSelectOneMode()" @click="flip('X')"><svg t="1650443094178" class="icon"
        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1549" width="14" height="14">
    ...
    <Button :disabled="notSelectOneMode()" @click="flip('Y')"><svg t="1650443104385" class="icon"
        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1749" width="14" height="14">
...
export default {
  ...
  methods: {
    ...
    flip(type) {
      ...
      activeObject.rotate(- activeObject.angle);
